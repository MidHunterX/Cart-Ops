...
class PurchasedItemTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final pricePerUnit = pItem.price;
    final totalPrice = (pItem.price - pItem.discount) * pItem.quantity;
                ...
                PopupMenuButton<String>(
                  ...
                  itemBuilder: (context) => [
                    const PopupMenuItem(
                      value: 'edit',
                      child: Row(
                        children: [Icon(Icons.edit_outlined), SizedBox(width: 8), Text('Edit All')],
                      ),
                    ),
                    const PopupMenuItem(
                      value: 'edit_quantity',
                      child: Row(
                        children: [Icon(Icons.numbers), SizedBox(width: 8), Text('Edit Quantity')],
                      ),
                    ),
                    const PopupMenuItem(
                      value: 'edit_price',
